...
* Завести машину - в консоль написать 'myCar.engine(true)'
* Поехать - в консоль написать 'myCar.go()'
* Информация об остатках в баке - в консоль написать 'myCar.showAllInformation()'
* Остановиться - в консоль написать 'myCar.stop()'
* Заглушить машину - в консоль написать 'myCar.engine(false)'
* */
class Car {
    engineState = false;
    gearState = false;
